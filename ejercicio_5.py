...
# ya elaborada
def ordenar_lista (lista_invitados):
    ordenar = sorted (lista_invitados, reverse = False)
    return ordenar
# --------------------------------
...
if __name__ == '__main__':
    ...
    cantidad = 3
    list_invi = generar_invitados(cantidad)

    print("Lista de invitados:")
    print(list_invi)
    
    lista_ordenada = ordenar_lista (list_invi)
    print('Invitados ordenados')
